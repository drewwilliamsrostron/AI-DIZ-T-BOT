...
class TradingGUI:
    ...
    def _build_notebook(self) -> None:
        ...
        New dashboard pages can be added here by creating a ``ttk.Frame`` and
        adding it to ``self.notebook``. Keep plotting logic in
        :meth:`update_dashboard`.
        """
    ...
    def _build_sidebar(self) -> None:
        ...
        Extend this method to display additional metrics. Use Tk variables
        where possible so updates are thread-safe via ``root.after``.
        """
